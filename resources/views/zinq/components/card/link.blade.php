@php
    ...
    if ($attributes->has('data-card-emerald')) {
        $separatorClass = 'my-6 border-emerald-400/70 dark:border-emerald-700';
    } elseif ($attributes->has('data-card-fuchsia')) {
        $separatorClass = 'my-6 border-fuchsia-400/70 dark:border-fuchsia-800';
    } elseif ($attributes->has('data-card-yellow')) {
        $separatorClass = 'my-6 border-yellow-400/70 dark:border-yellow-800';
    } elseif ($attributes->has('data-card-inverse')) {
        $separatorClass = 'my-6 border-zinc-900 dark:border-zinc-200';
...
<div class="w-full flex justify-end">
    <a href="#" class="{{ $linkClass }} hover:bg-zinc-950 hover:dark:bg-zinc-400" style="background-image: none;">
